...
\newcommand{\inlts}[1]{\lstinline[language=JavaScript, basicstyle=\small\ttfamily, keywordstyle=\color{blue}]{#1}}
\newcommand{\inltxt}[1]{\lstinline[basicstyle=\small\ttfamily]{#1}}

% code blocks - these do not work for some reason
% \newenvironment{codets}{\begin{lstlisting}[language=JavaScript, keywordstyle=\color{blue}, backgroundcolor=\color{lightgray}, basicstyle=\small\ttfamily, breaklines]}{\end{lstlisting}}
% \newenvironment{codebash}{\begin{lstlisting}[language=bash, keywordstyle=\color{blue}, backgroundcolor=\color{lightgray}, basicstyle=\small\ttfamily, breaklines]}{\end{lstlisting}}
% \newenvironment{codetxt}{\begin{lstlisting}[backgroundcolor=\color{lightgray}, basicstyle=\small\ttfamily, breaklines]}{\end{lstlisting}}
...
\begin{lstlisting}[language=JavaScript, keywordstyle=\color{blue}, backgroundcolor=\color{lightgray}, basicstyle=\small\ttfamily, breaklines]
...
\begin{lstlisting}[backgroundcolor=\color{lightgray}, basicstyle=\small\ttfamily, breaklines]
// pnpm run test:unit
...
\FloatBarrier
\begin{lstlisting}[language=bash, keywordstyle=\color{blue}, backgroundcolor=\color{lightgray}, basicstyle=\small\ttfamily, breaklines]
