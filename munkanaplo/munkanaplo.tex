...
\usepackage{cite} % optional, for number-style citations
\usepackage{url}  % for formatting URLs properly
...
\begin{figure}[ht]
  \centering
  \includegraphics[width = \textwidth]{images/login_diagram.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width = \textwidth]{images/further_requests_diagram.png}
...
telepítéséhez nagy segítség volt \acite{madakorADLab} YouTube videó.
...
konvertáljam dátum objektummá, melyet \aref{listing:active_directory_utils}.~kódban látható függvénnyel
oldottam meg \acite{pwdLastSet} segítségével.
...
\aref{listing:unison_files}.~kódban láthatók. A használatához felhasznált forrást lásd \acite{unison} dokumentumban.
